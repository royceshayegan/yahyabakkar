...
export class AppComponent {
  ...
  constructor(private youtube: YoutubeService, private router: Router, private activatedRoute: ActivatedRoute, private titleService: Title, private metaService: Meta) { }
